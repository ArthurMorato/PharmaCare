 ...
 */
public class StockLevelChangedEvent implements com.pharmacare.domain.core.common.DomainEvent {
...
public class InventoryItem extends ValueObject {
    ...
    // Eventos de domínio
    private final List<com.pharmacare.domain.core.common.DomainEvent> domainEvents;
     ...
     */
    private void registerDomainEvent(com.pharmacare.domain.core.common.DomainEvent event) {
    ...
    public List<com.pharmacare.domain.core.common.DomainEvent> getDomainEvents() {
